...
/**
 * SplashCursor — WebGL fluid splash effect that follows the mouse. The
 * canvas is fixed and full-viewport with `pointer-events: none` so it
 * never blocks clicks. Use sparingly: it renders on every frame and
 * should only be mounted on the section(s) where the effect is wanted.
 */

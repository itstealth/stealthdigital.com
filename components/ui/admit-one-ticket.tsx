// @ts-nocheck — vendored Paper Shaders / AdmitOneTicket code; not our TS surface.
"use client";
...
function createProgram(gl, vertexShaderSource2, fragmentShaderSource) {
  const format = gl.getShaderPrecisionFormat(gl.gl_FRAGMENT_SHADER ?? gl.FRAGMENT_SHADER, gl.MEDIUM_FLOAT);

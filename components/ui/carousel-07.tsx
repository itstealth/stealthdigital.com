...
const CarouselStacked = ({ slides = defaultSlides }: CarouselStackedProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full py-16 md:py-24 bg-black overflow-hidden select-none">
      <div className="relative w-full h-96 sm:h-[34rem] lg:h-[42rem] flex items-center justify-center">
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "w-56 h-72 sm:w-72 sm:h-96 lg:w-96 lg:h-[30rem]",
      )}
    >
      <img
        src={slide.image}

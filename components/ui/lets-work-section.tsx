...
/**
 * LetsWorkTogether — full-screen closing CTA. Clicking the big
 * "Let's work together" wordmark reveals a "Book a call" action.
 *
 * Replaces the previous CTA band ("Let's Build / Ready to scale?").
 * The booking button routes to /contact-us (Stealth has no public
 * Cal.com link); swap the URL in handleBookCall if one is added.
 */
      ...
      <div className="relative flex flex-col items-center gap-12">
        ...
        >
          ...
          <a
            ...
            className="text-xs tracking-widest uppercase text-muted-foreground/60 transition-colors hover:text-foreground"
          >
            {SITE.email}
          </a>
        </div>
